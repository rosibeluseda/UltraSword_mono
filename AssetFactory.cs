...
// Method return        :    -
//
// Synopsis             :   This class is where the animations for the game are initialized and assigned.  
//                                            
//                                    
// Modifications        :
...
//=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
    internal class AssetFactory
    {
        ...
        // Method               :   AssetFactory
        //
        // Method parameters    :   Texture2D cAtlas, Texture2D bAtlas, Texture2D hAtlas
        //
        // Method return        :    -
        //
        ...
        // Method               :   GetAsset
        //
        // Method parameters    :   int assetId
        //
        // Method return        :    -
        //
        // Synopsis             :   This method returns the respective animation in an array of the parameter received.. 
        //                                            
        //                                    
        // Modifications        :
        //                                            Date            Developer                Notes
